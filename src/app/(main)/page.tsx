    ...
    <>
      ...
      >
        ...
        <div className="flex-1">
          ...
          <p className="basic-description-color mt-8 hidden sm:block">
            Passionate Web &amp; Mobile Developer with 3+ years of professional experience. Specializing in creating
            innovative solutions using modern technologies. Proven track record of delivering high-quality.
          </p>
      ...
      <section className="mt-4 sm:hidden">
        <p className="mt-4 basic-description-color">
          Passionate Fullstack Web Developer with 2+ years of professional experience. Specializing in creating
          innovative solutions using modern technologies. Proven track record of delivering high-quality.
        </p>
